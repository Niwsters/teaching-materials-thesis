\chapter{Discussion}
\section{}
\todo{Some speculations that I decided to write down to see where the final report might end up. Better make risky speculations early rather than late, so we get a chance to revise them.}
