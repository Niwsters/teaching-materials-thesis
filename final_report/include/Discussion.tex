...
To begin with, "help" in this case is defined as both improving the quality of work of teachers, as well as the quality of their teaching. In this case, this is specified in how usability testing could affect teacher collaboration, collaboration between other material designers and teachers, how teachers' workload could be affected, and how teachers' access to new knowledge and perspectives could be affected. More aspects could of course be analysed, but these are the limitations of this discussion

By applying usability testing as a technological system, as defined by Franklin's theory, it can be further divided into a prescriptive approach and a holistic approach. The prescriptive approach would be characterized with usability testing being required for teaching materials to be taken seriously. In other words, teaching materials that wouldn't have usability tests to back them would be considered inferior, in a similar way that medicine that doesn't have the backing of medical science is often considered ineffective. If teachers would make their own materials, they would have to usability test them to share them with other teachers. In the more extreme variants, teaching material designers might also have to go through a usability testing course to have their tests be taken seriously, or follow a certain method described by a central educational authority.

In contrast to the prescriptive system, the holistic system would be less focused on using a specific method, and more focused on improving material designers' expertise in usability design. Usability testing would be a common technique among material designers, including teachers themselves.
