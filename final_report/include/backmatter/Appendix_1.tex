...
Here is another valuable link pointing to a list of all materials, including Swedish descriptions and more  (last updated 201808-22):
...
\begin{comment}
            ...
            \begin{adjustwidth}{-2.5cm}{}
                    \begin{tabular}{@{}c@{\hspace{.1cm}}c@{}}
                        \frame{\includegraphics[page=9,width=0.68\textwidth]{pdf/natverk}} &
                        \frame{\includegraphics[page=9,width=0.68\textwidth]{pdf/notes}}\\
                        \frame{\includegraphics[page=10,width=0.68\textwidth]{pdf/natverk}} &
                        \frame{\includegraphics[page=10,width=0.68\textwidth]{pdf/notes}} \\
                    \end{tabular}
            \end{adjustwidth}
            \end{figure}
\end{comment}
...
%\begin{adjustwidth}{-2.5cm}{}
    \begin{tabular}{l}%{@{}c@{\hspace{.1cm}}c@{}}
       % \subsubsection*{Presentation slides and teacher notes}\\
            ...
            \frame{\includegraphics[page=1,width=1\textwidth]{pdf/natverk}}\\
            \\
            Teacher notes slide 1 of 10\\
            \frame{\includegraphics[trim={0 3.5cm 0 0},clip,page=1,width=1\textwidth]{pdf/notes}}\\
        \end{tabular}
%\end{adjustwidth}
\end{figure}
...
%\begin{adjustwidth}{-2.5cm}{}
    \begin{tabular}{l}%{@{}c@{\hspace{.1cm}}c@{}}
            ...
            \frame{\includegraphics[page=\slidenr,width=1\textwidth]{pdf/natverk}}\\
            \\
            Teacher notes slide \slidenr of 10\\
            \frame{\includegraphics[trim={0 0cm 0 0},clip,page=\slidenr,width=1\textwidth]{pdf/notes}}\\
        \end{tabular}
%\end{adjustwidth}
\end{figure}
...
\frame{\includegraphics[page=1,width=1\textwidth]{pdf/tvetydig}}
\newpage
Teacher document page 2 of 4\\
\frame{\includegraphics[page=2,width=1\textwidth]{pdf/tvetydig}}
\newpage
Teacher document page 3 of 4\\
\frame{\includegraphics[page=3,width=1\textwidth]{pdf/tvetydig}}
\newpage
Teacher document page 4 of 4\\
\frame{\includegraphics[page=4,width=1\textwidth]{pdf/tvetydig}}