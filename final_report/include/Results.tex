...
\begin{figure}[H]
\centering
\includegraphics{figure/tabs1.png}
\includegrpahics{figure/tabs2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{figure/screenshot_materiallista_kleindagarna.png}
\caption{Presentation notes were introduced, to separate materials aimed towards teachers and students.}
\label{notes}
\end{figure}
