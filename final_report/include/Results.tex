...
\begin{itemize}
    ...
    \item The biggest remaining problem of the material design lies in a the student activity (the \textit{Explore}-phase of the lesson) where the class are to compile data to create a network. To be able to make the network and its analysis meaningful, it was suggested that the compiled data should be personal and able to lead to a finding. However this proved problematic.
		\begin{quote}
...
\textbr{\textit{Note:}} the quotes have been translated from Swedish to English.
\newpage
